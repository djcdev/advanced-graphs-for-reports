    ...
    <div class="AG-bar-graph-options">
        <div class="AG-bar-graph-options-row">
            <div class="AG-bar-graph-options-block">
                <!-- Show legend -->
                <label><input ref="show_legend" type="checkbox" v-model="show_legend" @change="updateParameters" /> {{module.tt("stacked_show_legend")}}</label>
            </div>
        </div>
      <div class="AG-bar-graph-options-row">
        <div class="AG-bar-graph-options-block">
            <h3>{{ module.tt("stacked_x_axis") }}</h3>
            <label>{{module.tt("stacked_bottom_margin")}}:<input ref="bottom_margin" type="number" v-model.number="bottom_margin" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_x_title_offset")}}:<input ref="x_title_offset" type="range" :min="0" :max="bottom_margin" v-model.number="x_title_offset" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_x_title_size")}}:<input ref="x_title_size" type="range" min="0" max="50" v-model.number="x_title_size" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_x_label_size")}}:<input ref="x_label_size" type="range" min="0" max="50" v-model.number="x_label_size" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_x_label_wrap")}}:
                <radio-component
                    v-model="x_label_limit"
                    :values="['truncate', 'wrap', 'none']"
                    :labels="[module.tt('stacked_truncate'), module.tt('stacked_wrap'), module.tt('stacked_none')]"
                    :defaultValue="'none'"
                    @update:modelValue="updateParameters"
                ></radio-component>
            </label>
            <label>{{module.tt("stacked_x_label_length")}}:<input ref="x_label_length" type="range" min="0" max="50" v-model.number="x_label_length" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_x_rotate")}}:<input ref="x_rotate" type="range" min="0" max="360" v-model.number="x_rotate" @input="updateParameters" /></label>
        </div>
        <div class="AG-bar-graph-options-block">
            ...
            <label>{{module.tt("stacked_y_label_wrap")}}:
                <radio-component
            ...
            <label>{{module.tt("stacked_y_label_length")}}:<input ref="y_label_length" type="range" min="0" max="50" v-model.number="y_label_length" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_y_rotate")}}:<input ref="y_rotate" type="range" min="0" max="360" v-model.number="y_rotate" @input="updateParameters" /></label>
        </div>
      </div>
      <div class="AG-bar-graph-options-row">
        <div class="AG-bar-graph-options-block">
            <h3>{{module.tt("stacked_bar_labels")}}</h3>
            <label>{{module.tt("stacked_bar_label_size")}}:<input ref="bar_label_size" type="range" min="0" max="50" v-model.number="bar_label_size" @input="updateParameters" /></label>
            <label>{{module.tt("stacked_bar_label_position")}}:<input ref="bar_label_position" type="range" min="-50" max="50" step="0.1" v-model.number="bar_label_position" @input="updateParameters" /></label>
        </div>   
      </div>                 
  </div>
</template>
